...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Number of masks for order agnostic training",
    )
    parser.add_argument(
        "--hs", type=str, default="128,32,128", help="Architecture of hidden layers"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--samples", type=int, default=5, help="Number of hidden layer resamples"
    )
    parser.add_argument(
        "--resample_every",
        type=int,
        default=20,
        help="How often to resample during training",
    )
    parser.add_argument(
        "--patience", type=int, default=10, help="Patience for early stopping"
    )
    parser.add_argument(
        "--dataset", type=str, default="dataset.pt", help="Path to preprocessed dataset"
    )
