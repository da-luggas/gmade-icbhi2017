...
if __name__ == "__main__":
    ...
    parser.add_argument("--bs", type=int, default=32, help="Batch size for dataloaders")
    ...
    parser.add_argument("--samples", type=int, default=3, help="Number of hidden layer resamples")
    parser.add_argument("--resample_every", type=int, default=50, help="How often to resample during training")
